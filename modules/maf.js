(function () {
  ...
  Maf.lerpAngleRad = function (a, b, t) {
    return Maf.toRadians(
      Maf.lerpAngleDeg(Maf.toDegrees(a), Maf.toDegrees(b), t)
    );
  };
  ...
  Maf.randomElement = function (elements) {
    return elements[Maf.intRandomInRange(0, elements.length)];
  };
